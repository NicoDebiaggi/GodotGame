...
const LEVEL_H:int = 1920	## height of levels (viewport) - only used by Zelda transition
const LEVEL_W:int = 1080	## width of levels (viewport) - only used by Zelda transition
...
var _loading_screen_scene:PackedScene = preload("res://Menus/Screens/Loading/Loading.screen.tscn")	## reference to loading screen PackedScene
